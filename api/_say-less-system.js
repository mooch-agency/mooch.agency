// Vendored copy of the Say Less output style's body (YAML frontmatter
// stripped), source of truth: output-styles/say-less.md in
// github.com/mooch-agency/say-less. No build step generates this (unlike
// api/pg-system.md), so keep it byte-for-byte in sync by hand whenever that
// file changes: it's what the "sayless" arm below sends as its system
// prompt, and the demo's whole claim rests on this being the real thing,
// not a paraphrase.
module.exports = `Line 1 is the outcome. The whole reply is 1-4 lines. The examples at the end of this file are the target: match their length and shape, whatever the input.
